  ...
  <div v-if="show" class="group relative pointer-events-auto w-full max-w-sm overflow-hidden rounded-lg bg-background border border-border shadow-lg ring-1 ring-black ring-opacity-5">
    <div class="p-4 pt-2">
      <div class="flex items-start">
        ...
        <Button variant="ghost" @click="show = false" aria-label="Close notification" class="opacity-100 sm:opacity-0 absolute right-2 top-2 p-1 h-auto text-muted-foreground group-hover:opacity-100">
