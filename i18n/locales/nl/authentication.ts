export default {
  authentication: {
    ...
    password_recovery: {
      ...
      password_reset_email_sent: "Als het e-mailadres is geregistreerd, wordt er een link verzonden naar",
      password_update_failed: "Bijwerken van wachtwoord mislukt",
      password_update_success: "Wachtwoord is bijgewerkt",
      reset_password: "Herstel link versturen",
      reset_your_password: "Wachtwoord herstellen",
      same_password: "Het wachtwoord moet afwijken van het huidige wachtwoord",
